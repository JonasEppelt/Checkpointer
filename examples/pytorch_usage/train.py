...
# In its basic configuration, it is enough to simply save and load the
# model checkpoint. For a more useful application, the losses, epoch
# number and more can be stored defining a custom `checkpoint_function`
